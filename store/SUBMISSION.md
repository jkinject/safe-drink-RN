...
| 7 (1.2.2) | `f3488c7` | 2026-09-11 EAS 빌드(술자리 그래프 이미지 공유 — view-shot+expo-sharing, 정점 기준 캐릭터, 앱 아이콘 푸터). aside(admin@epcompany.co.kr)로 프로덕션 100% 검토 제출, 출시 노트 ko/en. 경고는 R8 매핑 없음 하나뿐. **같은 날 12:36 게시됨**(Google Play에 제공됨). 이후 JS 수정 2건(영어 뱃지 줄바꿈·용어 통일)은 production OTA 로 게시 |
