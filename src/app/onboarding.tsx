...
const styles = StyleSheet.create({
  ...
  headerChar: { width: 120, height: 120, marginLeft: 12 },
  ...
  shieldChar: { width: 54, height: 54, marginLeft: 6 },
  privacyNote: {
    fontSize: 11,
    color: AppColors.sub,
    textAlign: 'center',
...
const fieldStyles = StyleSheet.create({
  ...
  inputWrapper: { flex: 1, paddingVertical: 2 },
  labelText: { fontSize: 12, color: AppColors.sub, fontWeight: '500', marginTop: 8 },
  ...
  unitText: { fontSize: 13, color: AppColors.sub, marginLeft: 4 },
